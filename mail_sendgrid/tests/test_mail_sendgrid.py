...
mock_sendgrid_api_client = (
    "odoo.addons.mail_sendgrid.models.mail_mail" ".SendGridAPIClient"
)
mock_sendgrid_send = (
    "odoo.addons.mail_sendgrid.models.mail_mail." "MailMail.send_sendgrid"
)
...
mock_template_api_client = (
    "odoo.addons.mail_sendgrid.models." "sendgrid_template.sendgrid.SendGridAPIClient"
)
...
class FakeTemplateClient(object):
    ...
    def __init__(self):
        ...
        self.body = json.dumps(
            {
                "templates": [{"id": "fake_id", "name": "Fake Template"}],
                "versions": [
                    {
                        "active": True,
...
class TestMailSendgrid(HttpCase):
        ...
        self.mail_template = self.env["mail.template"].create(
            {
                ...
                "sendgrid_template_ids": [
                    (
                        ...
                        {
                            "lang": "en_US",
                            "sendgrid_template_id": self.sendgrid_template.id,
                        },
                    )
                ],
            }
    ...
    def test_create_email(self):
        ...
        self.assertEqual(mail.sendgrid_template_id.id, self.sendgrid_template.id)
    ...
    def test_mail_tracking(self, m_config, mock_sendgrid):
        ...
        # Test mail processed
        self.event.update({"event": "processed", "odoo_id": mail.message_id})
    ...
    def test_update_templates(self, m_config, m_sendgrid):
        ...
        template = self.env["sendgrid.template"].search([("remote_id", "=", "fake_id")])
